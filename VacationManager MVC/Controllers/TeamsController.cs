...
namespace VacationManager_MVC.Controllers
{
    public class TeamsController : Controller
    {
        ...
        public TeamsController(VacationManagerContext context)
        {
            _context = context;
        }
        ...
        {
            var vacationManagerContext = _context.Teams.Include(t => t.Project);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VacationManagerContext.Teams'  is null.");
            }
            var team = await _context.Teams.FindAsync(id);
            if (team != null)
            {
