...
namespace VacationManager_MVC.Controllers
{
    public class VacationsController : Controller
    {
        ...
        {
            var vacationManagerContext = _context.Vacations.Include(v => v.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,BeggingDate,EndingDate,DateOfCreation,HalfDay,Approved,UserId")] Vacation vacation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BeggingDate,EndingDate,DateOfCreation,HalfDay,Approved,UserId")] Vacation vacation)
        {
            if (id != vacation.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VacationManagerContext.Vacations'  is null.");
            }
            var vacation = await _context.Vacations.FindAsync(id);
            if (vacation != null)
            {
